...
#[derive(Debug)]
pub struct TokenSwapProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenSwapProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenSwap processing");
    
    let mut processor = TokenSwapProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenSwapProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenSwapProcessor::new(false);
